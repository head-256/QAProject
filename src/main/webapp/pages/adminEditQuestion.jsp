...
<html>
<head>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/adminEditQuestion.css">
</head>
<body>
...
<div class="container-fluid">
	<div class="col">
		<form action="${pageContext.request.contextPath}/controller" method="post">
			<input type="hidden" name="command" value="save_admin_question_changes">
						...
						<table class="table">
							<tbody>
								...
								<tr>
									...
									<td>
										...
										<input type="text" name="tags" id="questionTagsInput"
											pattern="\s*([\p{L}0-9_][\p{L}0-9\-\s_]{1,14}[\p{L}0-9_])*(\s*,\s*[\p{L}0-9_][\p{L}0-9\-\s_]{1,14}[\p{L}0-9_]){0,15}" value="${ question.tagsAggregated }"
											title="${ tagsTitle }">
										<label class="error-label">
								...
								<tr>
									...
									<td>
										<textarea name="text" rows="6" maxlength="10000" disabled><c:out value="${ question.text }"/></textarea>
									</td>
								</tr>
							</tbody>
						</table>
